...
**Cancellation:** If the user cancels or dismisses any of the 4 prompts, halt immediately. Do not proceed to Phase 1 or draft any part of `AGENTS.md`. No partial file should be written.
